 ...
 * Last modified in 2022-07-29<br />
...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2022-07-29 at 14:54:54.
 */
class ExampleSuperclassTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $expected = "The constructor of the superclass received the number: 10.<br />";
        $this->assertEquals($expected, $this->object->returnMessage());
    }
}
